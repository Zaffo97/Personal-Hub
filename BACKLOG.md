...
| ⚠️ ⬜ | **L'elenco mosse di MA e MB esclude 159 mosse che Champions permette** | **Trovato il 14/09/2026 e non corretto**, perché è fuori scope. La tendina mosse del calcolatore è l'**intersezione** fra le mosse della regulation (`moves` nel filtro: 460 sia in MA sia in MB) e quelle che il Pokémon impara. Il filtro però non ha **159 mosse** che le liste `champions` danno. Colpisce **tutte** le 278 specie di MA con una lista (306 in MB). Le più frequenti: Endure e Substitute (277), Snore (243), Thief (143), Payback (86), Swords Dance (84), Crunch (77). Quindi **Crunch sparisce da Incineroar** in MA, senza avviso. Pawmot in MA mostra 51 mosse invece di 64. ⬜ **Da decidere con Davide**: l'elenco delle 460 è davvero quello delle mosse permesse in Champions, o è rimasto indietro? Nel secondo caso va allargato, con una fonte |
