...
> 4. ⬜ **Morpeko (Hangry Mode)** resta l'unica voce aperta del §5.2, e il 21/09/2026 ha
>    **molto più contesto** di quando è stata scritta. Nel dump ha 5 mosse in meno della
>    forma normale (Assurance, Payback, Rising Voltage, Round, Snore), Bulbapedia ha un
>    blocco solo per tutte e due e quindi non dice niente, e **tutte e due le forme sono in
>    MA e MB**: si vede, 60 mosse contro 65. Quello che si sa ora, misurato:
>    - delle **123** coppie forma/specie che in Champions hanno entrambe la lista, **99**
>      sono identiche e **24** diverse
>    - tutte e 24 sono forme regionali o davvero distinte (Alolan, Galarian, Hisuian,
>      Paldean, le Rotom, Lycanroc, Meowstic Femmina), e si riconoscono perché hanno
>      **mosse proprie** che la specie non ha
>    - **Morpeko Hangry è l'unica** con zero mosse proprie: solo 5 in meno, e basta
>    - e in `main` le due forme di Morpeko sono **identiche**, 67 e 67, zero differenze nei
>      due versi
>
>    Resta che **nessuna fonte lo conferma**, e la regola del punto 3 — *un'assenza da una
>    pagina non è una smentita* — vale anche qui. La differenza rispetto al 18/09 è che ora
>    la scelta è fra «allineo Hangry alla forma normale, con la misura qui sopra come
>    motivo» e «lascio, perché una misura non è una fonte»: **decide Davide**, e finché non
>    decide non si tocca
>
